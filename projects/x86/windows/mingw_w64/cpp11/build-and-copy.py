...
# 32 Bit versions
#
dstpath_release = os.path.join( my_globals.NQBP_PKG_ROOT(), 'src', 'Catch', 'libs', 'x86', 'windows', 'mingw_64', 'cpp11', '32bit', "release" )
dstpath_debug   = os.path.join( my_globals.NQBP_PKG_ROOT(), 'src', 'Catch', 'libs', 'x86', 'windows', 'mingw_64', 'cpp11', '32bit', "debug" )
...
# 64 Bit versions
#
dstpath_release = os.path.join( my_globals.NQBP_PKG_ROOT(), 'src', 'Catch', 'libs', 'x86', 'windows', 'mingw_64', 'cpp11', '64bit', "release" )
dstpath_debug   = os.path.join( my_globals.NQBP_PKG_ROOT(), 'src', 'Catch', 'libs', 'x86', 'windows', 'mingw_64', 'cpp11', '64bit', "debug" )
                 
#
# Build non-debug version
#
err, msg = utils.run_shell2( "nqbp.py -tb win64", True )
if ( err != 0 ):
    sys.exit( "ERROR: Release build failed.")
print( "Copying: {} TO\n         {}".format( srcpath, dstpath_release ) )
shutil.rmtree( dstpath_release, True );
...
# Build debug version
#
err, msg = utils.run_shell2( "nqbp.py -gtb win64", True )
if ( err != 0 ):
    sys.exit( "ERROR: Release build failed.")
print( "Copying: {} TO\n         {}".format( srcpath, dstpath_debug ) )
shutil.rmtree( dstpath_debug, True );
