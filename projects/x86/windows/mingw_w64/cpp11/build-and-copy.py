...
# 32 Bit versions
#
dstpath_release = os.path.join( my_globals.NQBP_PKG_ROOT(), 'libs', 'x86', 'windows', 'mingw_64', 'cpp11', '32bit', "release" )
dstpath_debug   = os.path.join( my_globals.NQBP_PKG_ROOT(), 'libs', 'x86', 'windows', 'mingw_64', 'cpp11', '32bit', "debug" )
...
# 64 Bit versions
#
dstpath_release = os.path.join( my_globals.NQBP_PKG_ROOT(), 'libs', 'x86', 'windows', 'mingw_64', 'cpp11', '64bit', "release" )
dstpath_debug   = os.path.join( my_globals.NQBP_PKG_ROOT(), 'libs', 'x86', 'windows', 'mingw_64', 'cpp11', '64bit', "debug" )
